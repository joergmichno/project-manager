...
export const kanbanTasks = {
    todo: [
        { id: "t1", title: "Design-System Dokumentation", description: "Alle UI-Komponenten dokumentieren und in Storybook erfassen.", priority: "medium", assignee: "JM", project: "E-Commerce Redesign", projectId: 1, startDate: "2026-02-25", deadline: "2026-03-05", createdAt: "2026-02-20", dependencies: [], comments: [] },
        { id: "t2", title: "CI/CD Pipeline einrichten", description: "GitHub Actions Pipeline für automatisches Testing und Deployment konfigurieren.", priority: "high", assignee: "KL", project: "Mobile App MVP", projectId: 2, startDate: "2026-02-20", deadline: "2026-03-05", createdAt: "2026-02-18", dependencies: [], comments: [] },
        { id: "t3", title: "Nutzerforschung Interviews", description: "5 User-Interviews durchführen und Key Insights dokumentieren.", priority: "low", assignee: "AS", project: "Dashboard Analytik", projectId: 4, startDate: "2026-03-05", deadline: "2026-03-20", createdAt: "2026-02-22", dependencies: [], comments: [] },
    ],
    inProgress: [
        { id: "t4", title: "Checkout-Prozess Neugestaltung", description: "Neuer 3-Schritt Checkout mit Apple Pay und Google Pay Integration.", priority: "critical", assignee: "JM", project: "E-Commerce Redesign", projectId: 1, startDate: "2026-02-01", deadline: "2026-03-01", createdAt: "2026-02-15", dependencies: ["t10"], comments: [{ author: "AS", text: "Wireframes sind ready, bitte reviewen!", time: "vor 2 Std." }] },
        { id: "t5", title: "REST API Endpunkte", description: "CRUD-Endpunkte für alle Ressourcen implementieren mit Swagger-Docs.", priority: "high", assignee: "MR", project: "API-Integration", projectId: 3, startDate: "2026-02-10", deadline: "2026-02-28", createdAt: "2026-02-10", dependencies: ["t9"], comments: [] },
        { id: "t6", title: "Push-Benachrichtigungsdienst", description: "Firebase Cloud Messaging für Push-Notifications einrichten.", priority: "medium", assignee: "BT", project: "Mobile App MVP", projectId: 2, startDate: "2026-02-25", deadline: "2026-03-10", createdAt: "2026-02-16", dependencies: [], comments: [] },
    ],
    review: [
        { id: "t7", title: "Zahlungsgateway Anbindung", description: "Stripe und PayPal als Zahlungsprovider integrieren und testen.", priority: "high", assignee: "JM", project: "E-Commerce Redesign", projectId: 1, startDate: "2026-02-08", deadline: "2026-03-05", createdAt: "2026-02-08", dependencies: ["t4"], comments: [{ author: "KL", text: "Testdaten im Staging bereit!", time: "vor 1 Std." }] },
        { id: "t8", title: "OAuth2 Implementierung", description: "OAuth2 Flow für alle externen APIs implementieren mit Token-Refresh.", priority: "critical", assignee: "KL", project: "API-Integration", projectId: 3, startDate: "2026-02-05", deadline: "2026-02-25", createdAt: "2026-02-05", dependencies: [], comments: [] },
    ],
    done: [
        { id: "t9", title: "Datenbankschema Entwurf", description: "PostgreSQL Schema für alle Entitäten designen mit Migrationen.", priority: "high", assignee: "JM", project: "Mobile App MVP", projectId: 2, startDate: "2026-02-01", deadline: "2026-02-15", createdAt: "2026-02-01", dependencies: [], comments: [] },
        { id: "t10", title: "Wireframes v2", description: "Überarbeitete Wireframes für alle Hauptseiten.", priority: "medium", assignee: "AS", project: "E-Commerce Redesign", projectId: 1, startDate: "2026-01-20", deadline: "2026-02-10", createdAt: "2026-01-28", dependencies: [], comments: [] },
        { id: "t11", title: "API Ratenbegrenzung", description: "Rate Limiting mit Redis implementieren: 100 req/min pro User.", priority: "high", assignee: "MR", project: "API-Integration", projectId: 3, startDate: "2026-02-10", deadline: "2026-02-20", createdAt: "2026-02-10", dependencies: [], comments: [] },
        { id: "t12", title: "Fehlerbehandlung Middleware", description: "Zentrale Error-Handling Middleware mit Logging und Sentry-Integration.", priority: "medium", assignee: "KL", project: "API-Integration", projectId: 3, startDate: "2026-02-05", deadline: "2026-02-18", createdAt: "2026-02-08", dependencies: [], comments: [] },
    ],
};
